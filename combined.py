...
add_selectbox = st.sidebar.selectbox("Select the Topic", option1=st.checkbox('Drag force proportional to $v^2$'), option2=st.checkbox('Drag force proportional to $v$'), option3=st.checkbox('Thermodynamics'), option4=st.checkbox('Heat Engine'))
if option1:

...
st.title('Classical Mechanics and Thermodynamics')
#st.header('', divider='rainbow')
col1,col2=st.columns(2)
with col1:
    st.image('classicalmechimg.jpeg')
with col2:
    st.image('thermo.jpg')
with st.sidebar:
...
if option1:
    ...
    st.markdown('Drag force is a mechanical force that acts opposite to the relative motion of any object moving with respect to a surrounding fluid.')
    st.image('drag.png')
